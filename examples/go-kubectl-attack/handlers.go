		...
		Parameters: []attack_kit_api.AttackParameter{
			{
				...
				DefaultValue: attack_kit_api.Ptr("false"),
			},
		},
...
func prepareRolloutRestart(w http.ResponseWriter, _ *http.Request, body []byte) {
	...
	state := make(attack_kit_api.AttackState)
