...
func getAttackList() action_kit_api.AttackList {
	return action_kit_api.AttackList{
...
func getRolloutRestartDescription() action_kit_api.AttackDescription {
	return action_kit_api.AttackDescription{
		...
		Parameters: []action_kit_api.AttackParameter{
			{
...
func prepareRolloutRestart(w http.ResponseWriter, _ *http.Request, body []byte) {
	var prepareAttackRequest action_kit_api.PrepareAttackRequestBody
	...
	state := make(action_kit_api.AttackState)
...
func startRolloutRestart(w http.ResponseWriter, _ *http.Request, body []byte) {
	var startAttackRequest action_kit_api.StartAttackRequestBody
...
func rolloutRestartStatus(w http.ResponseWriter, _ *http.Request, body []byte) {
	var attackStatusRequest action_kit_api.AttackStatusRequestBody
