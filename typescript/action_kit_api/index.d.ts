...
export type TargetSelectionTemplate = components['schemas']['TargetSelectionTemplate'];
export type TargetSelectionTemplates = components['schemas']['TargetSelectionTemplates'];
